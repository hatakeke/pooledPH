...
#  出力: FunnelPlot_Intercept.png, FunnelPlot_Slope.png, FunnelPlot_data.csv
# ==============================================================================
...
if (exists("model")) {
    ...
    # Intercept用ファネルプロット
    funnel_intercept <- create_funnel_plot_intercept(model, output_file = file.path(output_dir, "FunnelPlot_Intercept"))
    
    # Condition Slope用ファネルプロット
    funnel_slope <- create_funnel_plot_slope(model, output_file = file.path(output_dir, "FunnelPlot_Slope"))
